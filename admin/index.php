...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Hanap-Kita - Login Page</title>
    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('assets/img/hanapkita.png');">
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="index.php">
                                        ...
                                        <span class="font-size-xl">Hanap-Kita </span>
                                    </a>
                ...
                <input type="checkbox" id="remember" name="remember" <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?> style="margin-left: 15px;"/>
