...
<div class="col-md-6 col-sm-6">
 <label>Honors/Awards(if any)</label>
<input type="text" name="percentage" autocomplete="off" value="" class="form-control" maxlength="20">
</div>
 
<div class="col-md-6 col-sm-6">
<label>GPA</label>
 <input type="text" name="cgpa" required="true" autocomplete="off" value="" class="form-control" maxlength="3">
</div>
</div>
