...
<label>Industry</label>
 <input type="text" name="industry" placeholder="e.g. Construction, E-commerce, Automobile" autocomplete="off" value="<?php echo htmlentities($result->industry)?>">
</div>

          
<div class="col-md-6 col-sm-6">
<label>Type of Business Entity</label>
 <input type="text" name="typebusinessentity" placeholder="e.g. Private Company" autocomplete="off" value="<?php echo htmlentities($result->typeBusinessEntity)?>">
</div>

<div class="col-md-6 col-sm-6">
<label>Location</label>
 <input type="text" name="location" placeholder="e.g. Barangay 560 Sampaloc, Manila" autocomplete="off" value="<?php echo htmlentities($result->lcation)?>">
</div>
