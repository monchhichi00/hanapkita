...
<input type="email" name="emailid" id="emailid" onBlur="useremailAvailability()"  placeholder="you@gmail.com" autocomplete="off"  required>
...
<input type="text" name="contactnumber" id="contactnumber" onBlur="usercontactnoAvailability()"  placeholder="e.g. 097536267228" autocomplete="off" pattern="[0-9]+" title="only numeric digit allowed" maxlength="11" required>
